...
<https://docs.aws.amazon.com/powertools/python/latest/>`__ is a suite of
...
`Logger
<https://docs.aws.amazon.com/powertools/python/latest/core/logger/>`__
and `Tracer <https://docs.aws.amazon.com/powertools/python/latest/core/tracer/>`__
